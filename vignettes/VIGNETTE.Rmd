...
```{r}
## This function has a bug: $ operator not valid for atomic vectors
## Please fix, it's a beautiful function when it works
#getAudioFeatures("1E2WTcYLP1dFe1tiGDwRmT", output = "graph")
```
